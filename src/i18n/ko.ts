	...
	steps: {
		preparation: {
			...
			intro: {
				...
				explanation:
					"Android는 앱이 다크 모드와 같은 시스템 설정을 자동으로 변경하는 것을 제한합니다. 이 기능을 사용하려면 일회성 권한을 부여해야 합니다. 이 작업은 안전하고 되돌릴 수 있으며, 데이터에 액세스할 수 있는 권한을 부여하지 않습니다.",
		...
		connection: {
			...
			body: {
				...
				line2:
					'기기를 선택하면 연결을 확인하는 팝업이 Android 기기에 나타납니다.',
			},
			cantFind: {
				title: "기기를 찾을 수 없나요?",
				body:
