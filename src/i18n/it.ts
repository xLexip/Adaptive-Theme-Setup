	...
	steps: {
		...
		connection: {
			...
			body: {
				...
				line2:
					'Dopo aver selezionato il dispositivo, apparirà un popup sul tuo Android per confermare la connessione. Il popup potrebbe essere visibile solo se il dispositivo è sbloccato.',
			},
			cantFind: {
