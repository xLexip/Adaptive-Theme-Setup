		...
		<StepCard
			...
			{state === AdbConnectionState.ERROR && (
				<>
					...
					<details className="connection-already-in-use" aria-labelledby="connection-already-in-use-summary" open>
						<summary id="connection-already-in-use-summary">{t('steps.connection.alreadyInUse.title')}</summary>
						<p>
							{t('steps.connection.alreadyInUse.body')}
						</p>
						<code>{t('steps.connection.alreadyInUse.adbCommand')}</code>
					</details>
				</>
			)}
		</StepCard>
