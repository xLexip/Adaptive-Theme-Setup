...
export const de = {
	...
	steps: {
		...
		connection: {
			...
			alreadyInUse: {
				title: "Gerät bereits in Verwendung?",
				body:
					'Stelle sicher, dass kein anderes laufendes Programm mit deinem Gerät interagiert oder sich automatisch damit verbindet. ' +
					'Falls ADB installiert ist, kannst du folgenden Befehl auf deinem Computer ausführen, um eine bestehende ADB-Verbindung zu beenden:',
